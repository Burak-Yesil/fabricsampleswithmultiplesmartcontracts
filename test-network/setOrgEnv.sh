...
if [[ ${ORG,,} == "org1" || ${ORG,,} == "aggregator" ]]; then
...
elif [[ ${ORG,,} == "org2" || ${ORG,,} == "servicing" ]]; then
...
elif [[ ${ORG,,} == "org3" || ${ORG,,} == "accountspayable" ]]; then
...
elif [[ ${ORG,,} == "org4" || ${ORG,,} == "accounting" ]]; then
